...
export function registerDocumentsTools(server, globalState) {
    server.tool("find-documents", "Run a query against a collection", {
    ...
    }, async ({ database, collection, filter, projection, limit }) => {
    ...
    server.tool("insert-document", "Insert a document into a collection", {
        collection: z.string().describe("Collection name"),
        database: z.string().describe("Database name"),
        document: z
            .object({})
