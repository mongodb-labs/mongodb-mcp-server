...
export function registerConnect(server, globalState) {
    server.tool("connect", "Connect to a MongoDB instance", {
        ...
        try {
            ...
            if (typeof connectionStringOrClusterName === "string") {
                if (connectionStringOrClusterName.startsWith("mongodb://") ||
...
async function connect(connectionString, globalState) {
...
export function ensureConnected(globalState) {
